...
To enable the desired collaborative functionality the RFCPS system representing a single UAV contains the following components, see Figure .

\begin{figure}[h]
	\centering
	\includegraphics[width=40mm]{Pictures/Figure_02.pdf}
