...
\section{Rapid Prototyping Options}
...
\subsection{Coordinated Road Search by Multiple UAVs} Define abbreviations and acronyms the first time they are used in the text, even after they have been defined in the abstract. Abbreviations such as IEEE, SI, MKS, CGS, sc, dc, and rms do not have to be defined. Do not use abbreviations in the title or heads unless they are unavoidable.

\subsection{Cognitive Autonamition}

\subsection{Autonomous Thermal Soaring Gliders}
